<template>
    ...
    <header-content v-if="loggedIn" :user-id="username"></header-content>
...
export default {
    ...
    methods: {
        loginIn() {
            const foundUser = dbData.doctors.find((doctor) => {
                return (
                    doctor.login.username === this.username &&
                    doctor.login.password === this.password
                );
            });
